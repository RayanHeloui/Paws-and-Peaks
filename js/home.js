document.addEventListener("DOMContentLoaded", () => {
  ...
  window.addEventListener("scroll", () => {
    ...
    // 🎯 Image transform
imgLeft.style.transform = `translate(calc(-50% + ${scrollProgress * -100}px), -50%)`;
imgCenter.style.transform = `translate(calc(-50% + ${scrollProgress * -566}px), -50%)`;
imgRight.style.transform = `translate(calc(-50% + ${scrollProgress * -1030}px), -50%)`;
