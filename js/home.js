document.addEventListener("DOMContentLoaded", function () {
  ...
  if (heroSection && imgLeft && imgCenter && imgRight) {
    ...
    imgLeft.style.transform = `translate(${lerp(0, 300, initialProgress)}px, ${lerp(700, -60, initialProgress)}px)`;
    ...
    window.addEventListener('scroll', () => {
      ...
      imgLeft.style.transform = `translate(${lerp(0, 300, progress)}px, ${lerp(700, -60, progress)}px)`;
